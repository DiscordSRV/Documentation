...
#### [`...Level`](https://config.discordsrv.com/config/DebugLevel) {id="DebugLevel"}
- `0` - Disables debug messages
- `1` - Enables debug messages
- `2` - Enables debug messages w/ Stack Trace
#### [`...JDA`](https://config.discordsrv.com/config/DebugJDA) {id="DebugJDA"}
Enables/Disables debug messages for JDA.
#### [`...JDARestActionStacks`](https://config.discordsrv.com/config/DebugJDARestActionStacks) {id="DebugJDARestActionStacks"}
