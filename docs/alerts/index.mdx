...
:::info
Running Paper 1.21.5+ and alerts not working? Please read [our fully qualified class name migration guide](migration.mdx).
:::
...
Refer to the Bukkit/Paper API javadoc to find events & properties to use:
