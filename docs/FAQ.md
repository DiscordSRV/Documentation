...
If you run a cracked server or allow non-Java players to join, you can switch your AvatarURL from {uuid-nodashes} to use {username} instead. Since [crafatar.com](https://crafatar.com/) does not support usage of player names you have to switch to a less stable alternative like [cravatar.eu](https://cravatar.eu/) (less stable in terms of will return a Steve head if service is heavily used).
