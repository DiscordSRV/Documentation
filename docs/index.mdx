...
[:simple-discord: Discord](https://discordsrv.com/discord)
[:fontawesome-solid-faucet: SpigotMC](https://www.spigotmc.org/resources/discordsrv.18494/)
[:material-bucket-outline: BukkitDev](https://dev.bukkit.org/projects/discordsrv)

[:material-cloud-upload: Latest Release](https://get.discordsrv.com/)
[:material-cloud-tags: Latest Snapshot](https://snapshot.discordsrv.com/)
...
<Tabs>
    ...
    <TabItem value={"gradle"} label={"Gradle"}>
        ...
        dependencies {
            compileOnly 'com.discordsrv:discordsrv:'
        }
        ```
    </TabItem>
</Tabs>
