...
If you are looking to create alerts for LuckPerms related events, an addon is required for it:

* https://github.com/ANutley/LuckPermsAlerts
...
### LuckPerms
:::warning
This requires the [LuckPermsAlerts](https://github.com/ANutley/LuckPermsAlerts) plugin be installed for this to work
:::
