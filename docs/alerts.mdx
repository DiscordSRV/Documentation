...
<Tabs>
    <TabItem value='discord-guildmemberupdateboosttimeevent-1' label='GuildMemberUpdateBoostTimeEvent (Boosting)'>
        ...
        Channel: boosters
        Conditions:
        - '#event.getOldTimeBoosted == null || jdaEvent.getOldTimeBoosted().isBefore(jdaEvent.getNewTimeBoosted());'
        Embed:
        Color: "#00ff00"
        Author:
        ImageUrl: "{embedavatarurl}"
        Name: "{username} boosted the server :)"
        ```
    </TabItem>
    <TabItem value='discord-guildmemberupdateboosttimeevent-2' label='GuildMemberUpdateBoostTimeEvent (Not Boosting)'>
        ...
        Channel: boosters
        Conditions:
        - '#event.getNewTimeBoosted == null || !jdaEvent.getOldTimeBoosted().isBefore(jdaEvent.getNewTimeBoosted());'
        Embed:
        Color: "#00ff00"
        Author:
        ImageUrl: "{embedavatarurl}"
        Name: "{username} is no longer boosting the server :("
        ```
    </TabItem>
