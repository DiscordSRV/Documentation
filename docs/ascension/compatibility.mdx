...
| Server software       | Supported versions                                   | Available For Testing? |
|-----------------------|------------------------------------------------------|------------------------|
| [Bukkit], [Spigot], [Paper] | ✅ Minecraft 1.8.8 and up<br/>⚠️ Minecraft 1.7.10[^1] | Yes |
| [BungeeCord], [Waterfall] | ✅ Minecraft 1.7.10 and up                            | No |
| [Velocity]              | ✅ 3.0.0 and up<br/>❌ 2.0.0 and below                 | No |
| [Fabric]                | ✅ 1.21.4<br/>⚠️1.21 - 1.21.3[^2]<br/>❌ 1.20.4 and below[^2] | Yes |

[^1]: Requires [updating ASM](#) <!-- TODO: fix anchor (faq#asm-update) -->
[^2]: These versions have not been extensively tested. Please report in #ascension-testing in our Discord server if you can use the plugin on them without issue.
