...
<Tabs>
<TabItem value='kick-message' label='📷 Kick Message'>
![Must link account to play](/assets/javaw_12rAo3Y4RJ.png)
</TabItem>

<TabItem value='failed-role-message' label='📷 Failed to find subscriber role Message'>
![Must be subscribed to play](/assets/javaw_uJSdOF2OAa.png)
</TabItem>
</Tabs>
